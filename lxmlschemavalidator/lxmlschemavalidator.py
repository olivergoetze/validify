...
def assess_element_structure(element: etree.Element, element_sourceline: int, xmlns_def: dict, validation_rules: dict, validation_messages: list, validation_results: list) -> list:
    ...
    return validation_results # TODO: dict mit Meldungs-ID (Meldungen in Konkordanz-Funktion auslagern und über API verfügbar machen, damit das DPT die Meldungstexte beziehen kann) - Mapping der Meldungs-IDs auf Kategorien sollte im DPT selbst über eine Konkordanz erfolgen.)
