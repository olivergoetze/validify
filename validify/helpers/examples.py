def compile_example_rules() -> dict:
    ...
    ruleset["rule_conditions"].append({"text_values": ["DE-1234"], "attribute_values": [{"attribute 1": "value 1", "attribute 2": "value 2"}], "reference_elements": [{"element_name": "{urn:isbn:1-931666-22-9}c", "element_attrib": {"level": "file", "type": "dao"},"preceding_elements": 2}]})  # mit preceding_elements wird angegeben, wie viele Ebenen das referezierte Element vom zu prüfenden Element entfernt ist. z.B. 2, wenn c/did/unitid geprüft wird und ermittelt werden soll, ob in c das Attribut "level" den Wert "file" enthält.
